...
class Player(tk.Frame):
	...
	def create_frames(self):
		self.track = tk.LabelFrame(self, text='Music', 
	...
	def track_widgets(self):
		...
		self.songtrack = tk.Label(self.track, font=("Gabriola",16,"bold"),
						bg="Grey",fg="Black")
		self.songtrack['text'] = 'PI Music Player'
	...
	def control_widgets(self):
		...
		self.slider.grid(row=0, column=4, padx=16)
